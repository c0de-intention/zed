...
impl PullRequestDetailsView {
    fn render_empty_state(&self) -> impl IntoElement {
        v_flex()
            ...
            .child(
                Label::new("Create a pull request in GitHub to review changed files.")
...
impl PullRequestDetailsContent {
    pub(crate) fn loading() -> Self {
        Self {
            state: PullRequestDetailsContentState::Loading,
    ...
    pub(crate) fn not_found() -> Self {
        Self {
            state: PullRequestDetailsContentState::NotFound,
            details: PullRequestDetails {
                number: 0,
                title: "No pull request for current branch".to_string(),
                url: String::new(),
                body: String::new(),
                review_decision: None,
                review_requests: Vec::new(),
    ...
    pub(crate) fn loaded(
        details: PullRequestDetails,
        comments: Vec<PullRequestDetailsComment>,
    ) -> Self {
        Self {
            state: PullRequestDetailsContentState::Loaded,
            details,
            comments,
        }
    }
    ...
    fn is_not_found(&self) -> bool {
        self.state == PullRequestDetailsContentState::NotFound
    }
}
